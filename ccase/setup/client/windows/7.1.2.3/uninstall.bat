...
# systema("$installer -input $ccase/uninstall/clearcase_uninstall_response_nt_i386_7.1.2-7.1.2.6.xml")->ordie("Removal of ClearCase client failed.");
...
systema("$inst_mgr/uninstall.bat")->ordie("Removal of installation manager failed.");
